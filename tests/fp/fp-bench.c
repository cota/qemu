...
static const char * const op_names[] = {
    ...
    [OP_SQRT] = "sqrt",
    [OP_CMP] = "cmp",
    [OP_CONV] = "conv", /* float -> double, double -> float, etc. */
    [OP_MAX_NR] = NULL,
};
        ...
        case PREC_FLOAT32:
            ...
            for (i = 0; i < OPS_PER_ITER; i++) {
                ...
                case OP_CMP:
                    ...
                    break;
                case OP_CONV:
                    res.f64 = float32_to_float64(a, &soft_status);
                    break;
                default:
                    g_assert_not_reached();
                }
        ...
        case PREC_FLOAT64:
            ...
            for (i = 0; i < OPS_PER_ITER; i++) {
                ...
                case OP_CMP:
                    ...
                    break;
                case OP_CONV:
                    res.f32 = float64_to_float32(a, &soft_status);
                    break;
                default:
                    g_assert_not_reached();
                }
...
GEN_BENCH_ALL_TYPES(conv, OP_CONV, 1)
